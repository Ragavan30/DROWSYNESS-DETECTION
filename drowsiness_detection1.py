...
while(True):
    ...
    if(score >= 20):
        ...
        receiver_email = "karthikishore91203@gmail.com"
        password = "kmvwrwphnjsfamtu"
        ...
        body = "Drowsiness has been detected. Please see the attached image."
